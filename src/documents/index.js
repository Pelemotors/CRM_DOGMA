...
function agencyHeaderHtml(agency, badgeLabel, metaRightHtml) {
  ...
  const logoHtml = logo
    ? `<img src="${logo}" alt="YossiCar" style="max-height:72px;max-width:180px;object-fit:contain;display:block;margin-bottom:8px">`
    : '';
  return `
    <div class="row" style="align-items:flex-start">
      <div>
        ${logoHtml}
        <h1>${escapeHtml(agency.agencyName || 'יוסי קאר')}</h1>
